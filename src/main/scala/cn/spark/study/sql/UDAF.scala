...
object UDAF {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //构建数据集
    val nameArr = Array("Leo","Marry","Jack","Tom","Leo","Jack","Marry","Jack")
    ...
    //开始使用自定义函数
    val nameAngLenDF: DataFrame = sqlContext.sql("select name, strCount(name) from names group by name")
